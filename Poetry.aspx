<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Poetry.aspx.cs" Inherits="medicine" %>
...
<body>
    ...
    <div class="Container">
        ...
        <div>
            ...
            <a href="Product.aspx" class="a">All Product ></a>Poetry Books &gt;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
          <br />
       &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
             <img src="img/29.png" width="80%" style="height: 231px"/>

        <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Poetry Books</h1>
        
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                           ConnectionString="<%$ ConnectionStrings:mycon %>" 
                                                SelectCommand="SELECT * FROM [product] where s_name='Poetry' "  
                                     ...
                                     <table align="center" border="1" style="border:groove;">                               
                                        ...
                                        <tr>
                                            <td>
                                            <asp:Label ID="Label1" ForeColor="#204056" runat="server" Font-Size="1em" Text='<%# Eval("P_name") %>'></asp:Label><br>
