<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Story.aspx.cs" Inherits="food" %>
    ...
    <div class="Container">
        ...
        <div>
            ...
            <a href="home.aspx" class="a">Home ></a> 
             <a href="Product.aspx" class="a">All Product ></a>Story Books &gt;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
        <br />
       &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
       <img src="img/29.png" style="height: 224px; width: 83%"/>

        <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Story Books</h1>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                           ConnectionString="<%$ ConnectionStrings:mycon %>" 
                                                SelectCommand="SELECT * FROM [product] where s_name='Story' "  ProviderName="<%$ ConnectionStrings:mycon.ProviderName %>"></asp:SqlDataSource>
