<%@ Page Language="C#" AutoEventWireup="true" CodeFile="horror.aspx.cs" Inherits="home_care" %>
...
<body>
   ...
   <div class="Navigation">
        ...
        <div>
            ...
            <a href="Product.aspx" class="a">All Product ></a> Horror Books &gt;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
          <br />
       &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
             <img src="img/29.png" width="80%" style="height: 270px"/>

        <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Horror Books</h1>
        
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                           ConnectionString="<%$ ConnectionStrings:mycon %>" 
                                                SelectCommand="SELECT * FROM [product] where s_name='Horror' "  
                                            ProviderName="<%$ ConnectionStrings:mycon.ProviderName %>"></asp:SqlDataSource>
						               <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" 
                                        DataKeyField="id" RepeatColumns="4" Height="700px" Width="700px" CellPadding="10" align="center" >
                                     <ItemTemplate> 
        ...
        <br />
            ...
            <p class="footer-copy">Copyright @ 2021 All Rights Reserved | Designed By :- <a href="Default.aspx" style="color:white">Remsi Sukhadiya , Urvisha Pambha  And  Amisha Ambaliya </a></p>
